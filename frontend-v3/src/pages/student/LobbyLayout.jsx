...
export default function LobbyLayout({ username, attributes, sharedAttributes, attributesComplete, availableAttributes, updateDetails, confirmDetails }) {
  ...
  useEffect(() => {
    setCurrentGPA(attributes.get("current_gpa"));
    setGoalGrade(attributes.get("goal_grade"));
    setAvailability(attributes.get("availability"));
    setCommunication(attributes.get("communication"));
    setMeetingMode(attributes.get("meeting_mode"));
    setYear(attributes.get("year"));
    setSemester(attributes.get("semester"));
    setAccessibility(attributes.get("accessibility"));
    
    setSharingAttributes(sharedAttributes);

    setDisplayAttributes(attributesComplete);
  }, [code, navigate]);
